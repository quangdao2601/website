...
function send_mail($send_to, $send_to_fullname, $subject, $content, $option = array())
{
    global $config;
    ...
    try {
        ...
        //Recipients
        $mail->setFrom($config_email["smtp_user"], $config_email["smtp_fullname"],);  // nguoi gui
        $mail->addAddress($send_to, $send_to_fullname);     // nguoi nhan
